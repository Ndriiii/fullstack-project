    ...
    return (
            ...
            <nav>
                <div className = "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
                    <div className="flex justify-between h-16 items-center">
                        <Link href="/" className="text-2xl font-bold text-zinc-700 bg-zinc-200 rounded-lg px-7 py-1">
                            MyStore
                        </Link>
                        <div className="flex items-center space-x-10 text-lg">
                            ...
                            <Link href="/login" className="px-7 py-1 bg-zinc-200 text-zinc-700 rounded-lg hover:bg-zinc-300">
                                Login
                            </Link>
                          </div>
                      </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/2">
            <h1 className="text-5xl font-semibold text-zinc-700 leading-tight">
              Welcome
            </h1>
            <h1 className="text-5xl font-semibold text-zinc-700 mb-5">
              to our Store
            </h1>
            ...
            <Link
              href="/shop"
              className="px-8 py-3 bg-zinc-200 text-zinc-700 rounded-lg shadow hover:bg-zinc-400 transition ml-12"
            >
              Shop now!
            </Link>
          </div>
      ...
      <section id="shop" className="py-16 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-semibold text-zinc-700 text-left mt-10">
            Featured Product
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex flex-col items-center">
                ...
                <h2 className="text-lg mt-5 font-medium text-zinc-700">
                  Product Name
                </h2>
              </div>
            ))}
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="mt-4 space-y-2 text-sm">
                <p>
                  ...
                  />
                  <strong>Jl. Gajah Mada</strong>, Tiban Indah, Kec. Sekupang,
                  Kota Batam, Kepulauan Riau 29426
                </p>
              </div>
            </div>
